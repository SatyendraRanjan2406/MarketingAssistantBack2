...
class Command(BaseCommand):
    help = 'Create simple sample Google Ads data for testing sync functionality'
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            account, created = GoogleAdsAccount.objects.get_or_create(
                ...
                user=user,
                defaults={
                    'account_name': 'Sample Google Ads1 Account',
                    'currency_code': 'USD',
                ...
                for campaign in campaigns:
                    for ad_group in ad_groups[:3]:  # Limit to first 3 ad groups
                        for keyword in keywords[:5]:  # Limit to first 5 keywords
                            ...
                            # Generate simple performance data without complex calculations
